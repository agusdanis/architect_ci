	                ...
	                <div class="modal-body">
				    	<div class="row">
							...
							<div class='form-group col-md-6'>
			                    ...
			                    <select class="form-control" style="width: 100%;" id="add_pilihStaffId" onchange="add_Staffchange(this)">
									<option value="null">-- pilih nama --</option>
								<?php foreach ($person as $prs) { ?>
									<option value="<?php echo $prs->mkary_id; ?>"><?php echo $prs->mkary_namalengkap; ?></option>
								<?php } ?>
								</select>
