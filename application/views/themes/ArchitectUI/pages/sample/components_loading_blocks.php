                <!-- components_loading_blocks.php -->
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div class="page-title-icon">
                                    <i class="pe-7s-door-lock icon-gradient bg-night-fade">
                                    </i>
                                </div>
                                <div>Loading Blocks
                                    <div class="page-title-subheading">Sometimes we need to show a loading indicator for some elements, like cards or tables.
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="main-card mb-3 card">
                                        <div class="card-body"><h5 class="card-title">Basic</h5>
                                            ...
                                            <div class="font-icon-wrapper float-left mr-3 mb-3">
                                                ...
                                                <p>ball-clip-rotate-pulse</p></div>
                                            <div class="font-icon-wrapper float-left mr-3 mb-3">
                                                <div class="loader-wrapper d-flex justify-content-center align-items-center">
                                                    <div class="loader">
                                            ...
                                            <div class="font-icon-wrapper float-left mr-3 mb-3">
                                                ...
                                                <p>ball-clip-rotate-multiple</p></div>
                                            <div class="font-icon-wrapper float-left mr-3 mb-3">
                                                <div class="loader-wrapper d-flex justify-content-center align-items-center">
                                                    <div class="loader">
                                            ...
                                            <div class="font-icon-wrapper float-left mr-3 mb-3">
                                                ...
                                                <p>line-scale-pulse-out-rapid</p></div>
                                            <div class="font-icon-wrapper float-left mr-3 mb-3">
                                                <div class="loader-wrapper d-flex justify-content-center align-items-center">
                                                    <div class="loader">
                                            ...
                                            <div class="font-icon-wrapper float-left mr-3 mb-3">
                                                ...
                                                <p>ball-scale-ripple-multiple</p></div>
                                            <div class="font-icon-wrapper float-left mr-3 mb-3">
                                                <div class="loader-wrapper d-flex justify-content-center align-items-center">
                                                    <div class="loader">
