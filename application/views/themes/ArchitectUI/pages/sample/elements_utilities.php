                    ...
                    <div class="app-page-title">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="dropdown-menu-header">
                                                    <div class="dropdown-menu-header-inner bg-mean-fruit">
                                                        <div class="menu-header-image" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract2.jpg');"></div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="dropdown-menu-header">
                                                    <div class="dropdown-menu-header-inner bg-amy-crisp">
                                                        <div class="menu-header-image" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract3.jpg');"></div>
                                                        <div class="menu-header-content">
                                                            <div><h5 class="menu-header-title">Settings</h5><h6 class="menu-header-subtitle">Manage all of your options</h6></div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="dropdown-menu-header">
                                                    <div class="dropdown-menu-header-inner bg-arielle-smile">
                                                        <div class="menu-header-image" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract4.jpg');"></div>
                                                        <div class="menu-header-content">
                                                            <div><h5 class="menu-header-title">Settings</h5><h6 class="menu-header-subtitle">Manage all of your options</h6></div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="dropdown-menu-header">
                                                    <div class="dropdown-menu-header-inner bg-grow-early">
                                                        <div class="menu-header-image" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract5.jpg');"></div>
                                                        <div class="menu-header-content">
                                                            <div><h5 class="menu-header-title">Settings</h5><h6 class="menu-header-subtitle">Manage all of your options</h6></div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Background Images</h5>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract1.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract2.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract3.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract4.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract5.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract6.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract7.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract8.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract9.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/abstract10.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/city1.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/city2.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/city3.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/city4.jpg');"></div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="demo-image-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/sidebar/city5.jpg');"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
