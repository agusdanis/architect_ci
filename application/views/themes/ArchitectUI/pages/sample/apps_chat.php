                                    ...
                                    <div class="app-inner-layout__top-pane">
                                        <div class="pane-left">
                                            ...
                                            <div class="avatar-icon-wrapper mr-2">
                                                ...
                                                <div class="avatar-icon avatar-icon-xl rounded"><img width="82" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/1.jpg" alt=""></div>
                                            </div>
                                    ...
                                    <div class="chat-wrapper">
                                        ...
                                        <div class="chat-box-wrapper">
                                            <div>
                                                <div class="avatar-icon-wrapper mr-1">
                                                    <div class="badge badge-bottom btn-shine badge-success badge-dot badge-dot-lg"></div>
                                                    <div class="avatar-icon avatar-icon-lg rounded"><img src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/2.jpg" alt=""></div>
                                                </div>
                                            </div>
                                            <div>
                                ...
                                <div class="app-inner-layout__sidebar-footer pb-3">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="text-center p-2 nav-item">
                                            <div class="avatar-wrapper avatar-wrapper-overlap">
                                                ...
                                                <div class="avatar-icon-wrapper">
                                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                                    <div class="avatar-icon rounded"><img
                                                            src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/10.jpg"
                                                            alt=""></div>
                                                </div>
                                                <div class="avatar-icon-wrapper">
                                                    <div class="badge badge-bottom badge-danger badge-dot badge-dot-lg"></div>
                                        ...
                                        <li class="nav-item-btn text-center nav-item">
                                            <button class="btn-wide btn-pill btn btn-success btn-sm">Offline Group Conversation</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
