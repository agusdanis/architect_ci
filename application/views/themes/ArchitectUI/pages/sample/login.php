                ...
                <div class="h-100 no-gutters row">
                            ...
                            <div class="slick-slider">
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-plum-plate" tabindex="-1">
                                        <div class="slide-img-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/originals/city.jpg');"></div>
                                ...
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                                        <div class="slide-img-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/originals/citynights.jpg');"></div>
                                ...
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-sunny-morning" tabindex="-1">
                                        <div class="slide-img-bg" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/originals/citydark.jpg');"></div>
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h6 class="mt-3">No account? <a onclick="signup()" href="javascript:void(0);" class="text-primary">Sign up now</a></h6>
                            ...
                            <div>
                                <form class="">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="ml-auto">
                                            <a href="javascript:void(0);" onclick="recoverpass()" class="btn-lg btn btn-link">
                                                Recover Password
                                            </a>
        ...
        <script type="text/javascript">
            ...
            function recoverpass(){
                //alert('ok');
                var url="<?php echo site_url('login/forgot_password');?>";
                window.location = url;
            }
        </script>