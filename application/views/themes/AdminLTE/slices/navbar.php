    ...
    <form class="form-inline ml-3">
      <div class="input-group input-group-sm">
        <input id="cariSesuatu" class="form-control form-control-navbar" type="text" placeholder="Search" aria-label="Search">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <!--
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">mpro_id: <?php echo $this->session->userdata('mpro_id');?> / user_id: <?php echo $this->session->userdata('user_id');?></a>
      </li>
      -->
      
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">You are login as: <?php echo $this->session->userdata('rolecode');?></a>
      </li>
      <li class="nav-item">
