                                                ...
                                                <ul class="rm-list-borders rm-list-borders-scroll list-group list-group-flush">
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="38" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/1.jpg" alt="">
                                                                </div>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="38" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/2.jpg" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="38" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/3.jpg" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="38" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/4.jpg" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="38" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/5.jpg" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left mr-3">
                                                                    <img width="38" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/8.jpg" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
