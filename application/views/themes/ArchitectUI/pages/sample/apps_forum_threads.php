                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Forum Threads
                                    <div class="page-title-subheading">Example layout page for forum threads
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-none d-md-block col-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-8 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/2.jpg" alt="" class="d-block ui-w-30 rounded-circle">
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-8 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/3.jpg" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <div class="line-height-1 text-truncate">1 day ago</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-8 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/4.jpg" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <div class="line-height-1 text-truncate">1 day ago</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-8 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/5.jpg" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <div class="line-height-1 text-truncate">1 day ago</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-8 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/6.jpg" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <div class="line-height-1 text-truncate">1 day ago</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-8 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/7.jpg" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <div class="line-height-1 text-truncate">1 day ago</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-8 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/8.jpg" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <div class="line-height-1 text-truncate">1 day ago</div>
                            ...
                            <div class="row no-gutters align-items-center">
                                ...
                                <div class="d-none d-md-block col-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="media col-8 align-items-center">
                                            <img style="width: 40px; height: auto;" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/9.jpg" alt="" class="d-block ui-w-30 rounded-circle">
                                            <div class="media-body flex-truncate ml-2">
                                                <div class="line-height-1 text-truncate">1 day ago</div>
