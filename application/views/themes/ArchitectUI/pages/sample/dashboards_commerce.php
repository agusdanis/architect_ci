                <!-- dashboard_commerce.php -->
                    <div class="app-page-title">
                        ...
                        <li class="nav-item">
                            <a role="tab" class="nav-link active" href="<?php echo site_url('dashboards/dashboards_commerce');?>">
                                <span>Variation 1</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a role="tab" class="nav-link" href="<?php echo site_url('dashboards/dashboards_commerce_v2');?>">
                                                    ...
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <div class="widget-content-left">
                                                                    <img width="40" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/4.jpg" alt="">
                                                                </div>
                                                            </div>
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <div class="widget-content-left">
                                                                    <img width="40" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/3.jpg" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="widget-content-left flex2">
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <div class="widget-content-left">
                                                                    <img width="40" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/2.jpg" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="widget-content-left flex2">
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <div class="widget-content-left">
                                                                    <img width="40" class="rounded-circle" src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/1.jpg" alt=""></div>
                                                            </div>
                                                            <div class="widget-content-left flex2">
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3 profile-responsive card">
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-dark">
                                            <div class="menu-header-image opacity-2" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/dropdown-header/abstract2.jpg');"></div>
                                            <div class="menu-header-content btn-pane-right">
                                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                                    <div class="avatar-icon rounded"><img src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/3.jpg" alt="Avatar 5"></div>
                                                </div>
                                                <div>
                            ...
                            <div class="col-sm-12 col-lg-6 col-xl-4">
                                <div class="mb-3 profile-responsive card">
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-dark">
                                            <div class="menu-header-image opacity-4" style="background-image: url('<?php echo base_url();?>assets/ArchitectUI/assets/images/dropdown-header/city1.jpg');"></div>
                                            <div class="menu-header-content btn-pane-right">
                                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                                    <div class="avatar-icon rounded">
                                                        <img src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/8.jpg" alt="Avatar 5">
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-dark">
                                            ...
                                            <div class="menu-header-content btn-pane-right">
                                                <div class="avatar-icon-wrapper mr-3 avatar-icon-xl btn-hover-shine">
                                                    <div class="avatar-icon rounded">
                                                        <img src="<?php echo base_url();?>assets/ArchitectUI/assets/images/avatars/1.jpg" alt="Avatar 5"></div>
                                                </div>
                                                <div>
