                <!-- components_scrollable_elements.php -->
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    ...
                                    <div class="btn-group dropdown">
                                        <button type="button" aria-haspopup="true" data-toggle="dropdown" aria-expanded="false" class="mb-2 mr-2 dropdown-toggle btn btn-primary">Bottom Header Buttons</button>
                                    ...
                                    <div class="btn-group dropdown">
                                        <button type="button" aria-haspopup="true" data-toggle="dropdown" aria-expanded="false" class="mb-2 mr-2 dropdown-toggle btn btn-success">Left Aligned Header</button>
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-lg dropdown-menu">
                                            <div class="dropdown-menu-header">
                                    ...
                                    <div class="btn-group dropdown">
                                        <button type="button" aria-haspopup="true" data-toggle="dropdown" aria-expanded="false" class="mb-2 mr-2 dropdown-toggle btn btn-secondary">Left Aligned Header Buttons</button>
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-lg dropdown-menu">
                                            <div class="dropdown-menu-header">
