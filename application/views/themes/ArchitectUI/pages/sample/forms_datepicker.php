                <!-- forms_datepicker.php -->
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div class="page-title-icon">
                                    <i class="pe-7s-battery icon-gradient bg-plum-plate">
                                    </i>
                                </div>
                                <div>Datepicker
                                    <div class="page-title-subheading">Build beautiful datepickers perfectly integrated in the general style of the application.
                                    </div>
                                </div>
                            </div>
