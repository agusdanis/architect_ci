                <!-- widgets_chart_boxes2.php -->
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                <div class="page-title-icon">
                                    <i class="pe-7s-plug icon-gradient bg-arielle-smile">
                                    </i>
                                </div>
                                <div>Chart Boxes II
                                    <div class="page-title-subheading">Unlimited styles are available for our chart boxes. Check out our dashboard examples for more.
                                    </div>
                                </div>
                            </div>
